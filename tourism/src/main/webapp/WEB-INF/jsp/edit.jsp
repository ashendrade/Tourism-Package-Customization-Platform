...
<head>
    ...
    <title>Edit Destination - Tourism Platform</title>
    ...
    <style>
        ...
        * {
        ...
        .id-display {
            ...
            align-items: center;
            gap: 12px;
            box-shadow: 0 5px 20px rgba(31, 41, 55, 0.3);
        }
...
<body>
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/destinations/update/${destination.destinationId}" method="post">
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="destinationName" class="form-control"
                           value="${destination.destinationName}" required>
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <input type="number" name="price" class="form-control"
                           value="${destination.price}" required step="0.01" min="0">
                </div>
